    ...
    <div class="courses-container">
      <div class="course">
        <div class="course-preview">
          <img :src="getImg(movie.image)" alt="affiche" />
        </div>
        <div
          class="course-info"
...
export default {
  ...
  methods: {
    ...
    getImg(url) {
      ...
      return "https://via.placeholder.com/166x250?text=Loading+Image";
    },
  },
  async created() {
    let data = await axios.get(PATH_URL + this.$route.params.filmId);
